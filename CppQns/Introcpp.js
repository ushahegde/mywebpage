...
new Question('What is the output of the following program?','#include &lt;iostream &gt;<BR> int main()<BR>{<BR>   int m=10;<BR>   float x =9.88f<BR>   cout&lt;&lt;m;<BR>}','109.88','10 9.88','Compiler error','p',3),
...
new Question('What is the error in this program?','#include &lt;iostream &gt;<BR> using std::cin;<BR>int main()<BR>{<BR>     float n;<BR>     cin &gt;&gt;n;<BR>}','using namespace std;<BR>is missing','No error.','We should include  &lt;cin &gt;in the program','l',2),
new Question('What are the errors in this code?','int a = 10;<BR>bool b = a;<BR>if(a &gt;5)<BR>   b = true;','b = a  is wrong','use b= TRUE instead of b=true;','No error','l',3),
