 ...
 var questions = [new Question('Which of these is correct way of declarating a function which prints an array  n integers? ',['void print_array(int a[n]);','void print_array(int a);','void print_array(int *a,int n);','None of the above'],3),
...
new Question('Consider the following declaration of a two dimensional array in C:<br>         char a[100][100];<br>Assuming that the main memory is byte addressable and that the array is stored starting from memory address 0, the address of a[40][50] is ',['4040','4050','5040','5050'],2),
new Question('If a two dimensional array of integer is sent as paramter to function, it gets implicitly converted to ',[' A pointer to pointer to integer','A pointer to integer','A pointer to an array of integers','None of these'],3),
...
new Question('How do you find the number of elements in an array arr? ',['sizeof(arr)','sizeof(arr)*4','sizeof(arr)/sizeof(arr[0])','None of the above'],3),
...
new Question('What is the correct way of declaring an int arr with ten elements whose first element is 100 and all the rest are 0 ',['int arr[10]={100,0,0,0,0,0,0,0,0,0};','int arr[10]=100','int arr[10]={100};','Both 1 and 3'],4),
new Question('Which of the following is the right method of initializing a char array? ',['char str[]="Hello";','char str[5]="Hello";','char str[6]="Hello";','None of the above'],1),
new Question('What is the correct way of initializing a 2 dimensional array of 2 rows and 2 columns? ',['int arr[2,2]={{1,2},{3,4}};','int arr(2)(2)={1,2,3,4};','int arr[2][2]={1,2,3,4};','None of the above'],3),
...
new Question('When an array is sent as an argument to a function, ------ gets passed to function ',['Size of array','Address of last element of array','Base address of array','None of the above'],3),
...
new Question('Which of the following codes finds the product of all n elements of an array? ',['for(i=0,product=0;i<n;i++)<br>    product*=arr[i];','for(i=0,product=1;i<n;i++)<br>    product*=arr[i];',' i=0;product=1;<br>while(i<5)<br>    product*=arr[i++];','Both 2 and 3'],4),
];
