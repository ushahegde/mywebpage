...
new Question("In command line arguments, agrc is a/an….......<br><br> ",["String","Array of char pointers","Integer","none of these"],3),
...
new Question("What is the correct syntax for command line arguments?<br><br> ",["<div class='codetext'>int main(int argc, char *argv[])</div>","<div class='codetext'>int main(char *argc,int argv)</div>","<div class='codetext'>int main(int argc,char **argv)</div>","Both 1 and 3"],4),
new Question("What is argv[0] in command line arguments?<br><br> ",["The first argument","Executable command","Total number of arguments","None of the above"],2),
new Question("What does the following program display if it is called as <br>./a.out hello<br><br><div class='codetext'>#include&lt;stdio.h&gt;<br>int main(int argc,char *argv[])<br>{<br>&ensp;     printf('The string sent is %s',argv[1]);<br> &ensp;    return 0;<br>}<br>    <br></div>",["The string sent is hello","The string sent is ./a.out hello","The string sent is ./a.out","None of the above"],1),
...
new Question("What is the output of the following program <div class='codetext'>#include&lt;stdio.h&gt;<br>int&nbsp;main(int&nbsp;n,char&nbsp;*m[])<br>{<br>&nbsp;FILE&nbsp;*fptr;<br>&nbsp;fptr&nbsp;=&nbsp;fopen(m[1],'r');<br>&nbsp;while(!feof(fptr))<br>&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;int ch=fgetc(fptr);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (ch!=EOF)<br>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;putchar(ch);<br>&nbsp;&nbsp;}<br>&nbsp;&nbsp;fclose(fptr);<br>&nbsp;&nbsp;return&nbsp;0;&nbsp;&nbsp;<br>}",["No output","Syntax error","Content of file whose name is given in command line","content of file m[1]"],3)
