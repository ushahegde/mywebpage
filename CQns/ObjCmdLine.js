...
var questions = [new Question("In command line arguments, <i>argv</i> is a/an….......<br>",["pointer to an array of character pointers","array of strings","array of character pointers","none of these"],3),
...
new Question("What is the correct syntax for command line arguments?<br> ",["<div class='codetextans'>int main(int argc, char *argv[])</div>","<div class='codetextans'>int main(char *argc,int argv)</div>","<div class='codetextans'>int main(int argc,char **argv)</div>","Both 1 and 3"],4),
