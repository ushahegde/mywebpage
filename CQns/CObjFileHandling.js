...
new Question("What does the following program do?<br><br><br><div class='codetext'>int main()<br>{<br>&nbsp;&nbsp;  FILE *fp;&nbsp;&nbsp;  signed char ch;<br>&nbsp;&nbsp; &nbsp;int i=1;<br>&nbsp;&nbsp;  fp = fopen('myfile.c', 'r');<br>&nbsp;&nbsp;  while((ch=getc(fp))!=EOF)<br>&nbsp;&nbsp;      {<br> &nbsp;&nbsp;&nbsp;&nbsp;if(ch == '\n')<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            i++; <br>&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;  fclose(fp);<br>&nbsp;&nbsp;return 0;<br>}<br></div>",["Prints the contents of the file","Counts all the characters in the file and prints it. ","Counts the number of words in the file but does not print it","None of the above"],3),
